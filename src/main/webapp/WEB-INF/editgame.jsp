...
<h1> Update Game <c:out value="${loggedUser.name }" /></h1>


<div  class="mx-auto" style="width: 90%;"> 
	<div class="col">
	<form:form action="/games/${thisGame.id}/edit" method="post" modelAttribute="thisGame">
			...
			<input type="submit" class="btn btn-primary offset - 2 col -2" value="Update Game">
	</form:form>
	</div>
</div>
</body>
